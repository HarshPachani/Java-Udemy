...
public class N_16_Pokerito {
    public static void main(String[] args) {
        ...
        */
        ...
        String compuerCard = randomCard();

        System.out.println("Here's your card:");
        System.out.println(yourCard);
        System.out.println("\nHere's the computer's card:");
        System.out.println(compuerCard);
     ...
     *   2. Returns a card that matches the random number (get the String values from cards.txt).
     */
