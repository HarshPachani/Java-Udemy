...
public class N_17_Challenge_5_BlackJack {
    ...
    public static void main(String[] args) {
        ...
        int total = Math.min(card1,10) + Math.min(card2,10);    //To return the minimum numbers.
        ...
        switch (cardNumber){
            ...
            case 13:
                return"   _____\n" +
                        ...
                        "  | |%%%|\n" +
                        "  |_%%%>|\n";
            default:return "This is never gonna call";
        }
    }
    ...
    public static String hitOrStay(){
        ...
        while(!(response.equalsIgnoreCase("hit") || response.equalsIgnoreCase("stay"))){    //To ignore the upper and lower case problems.
